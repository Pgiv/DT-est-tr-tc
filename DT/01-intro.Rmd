...
Cette analyse permet tout d'abord de montrer comment les problèmes d'optimisation des filtres issus des RKHS peuvent probablement conduire à des filtres sous-optimaux (augmentation des révisions et du délai dans la détection des points de retournement).
