...
Cette étude décrit l'ensemble de ces méthodes en développant une formulation générale pour la construction des filtres, permettant de mettre en exergue les spécificités de chacune, et compare leurs performances, en termes de révision et de délai dans la détection des points de retournement, sur des séries simulées et réelle.
Elle montre également comment les filtres polynomiaux locaux peuvent être étendus pour contrôler le déphasage induit par l'utilisation de filtres asymétriques et proposent une méthode de paramétrisation locale de ces filtres.
