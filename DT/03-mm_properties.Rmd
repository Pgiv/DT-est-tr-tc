...
En début et en fin de série, les moyennes mobiles asymétriques ne peuvent être utilisées du fait du manque de données disponibles. <!-- ces deux phrases sont très semblables : est-ce qu'on ne peut pas merger les deux idées?--> 
...
Cependant, puisque les coefficients du filtre symétrique décroissent lentement, il faudrait également s'intéresser à la performance des prévisions à horizon de plusieurs périodes --- *multi-step ahead forecasting*.
