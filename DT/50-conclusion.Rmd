...
Premièrement, en période de retournement conjoncturel, des filtres asymétriques utilisées comme alternative au prolongement de la série par modèle ARIMA peuvent donner de bons résultats.
...
Enfin, la moins bonne performance apparente des certains filtres (notamment RKHS) pourrait provenir de l'utilisation de filtres sous-optimaux lorsque que l'on s'approche du cas d'utilisation du filtre symétrique. 
