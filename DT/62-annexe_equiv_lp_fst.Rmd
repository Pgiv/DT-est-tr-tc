...
Lorsqu'un graphique n'est pas affiché c'est que tous les filtres FST sont équivalents à une approche polynomiale locale par moindres carrés pondérés.
...
Un quadrillage de 200 points de l'intervalle $[0,1]$ a été effectué et on ne garde que l'ensemble des poids tels que leur somme fasse 1.
].
